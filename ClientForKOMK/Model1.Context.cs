...
namespace ClientForKOMK
{
    ...
    public partial class KOMK_v11_Procedure_BasePackEntities2 : DbContext
    {
        public KOMK_v11_Procedure_BasePackEntities2()
            : base("name=KOMK_v11_Procedure_BasePackEntities2")
        {
        }
