...
namespace ClientForKOMK
{
    ...
    public partial class KOMK_v11_Procedure_BasePackEntities : DbContext
    {
        public KOMK_v11_Procedure_BasePackEntities()
            : base("name=KOMK_v11_Procedure_BasePackEntities")
        {
        }
